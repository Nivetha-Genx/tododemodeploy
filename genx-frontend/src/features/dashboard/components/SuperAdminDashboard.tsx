        ...
        <div className="space-y-6 sm:space-y-8 animate-in fade-in duration-700 px-4 lg:px-0 pb-8">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                ...
                <Button
                    ...
                    className="bg-brand-600 hover:bg-brand-700 text-white rounded-xl px-3 md:px-4 py-2 md:py-2 h-auto font-bold shadow-lg shadow-brand-100 w-full md:w-auto transition-all duration-200 active:scale-95 shrink-0"
                >
                    <Plus className="w-3.5 h-3.5 md:w-4 md:h-4 mr-1 md:mr-1.5" />
                    <span className="text-xs md:text-sm whitespace-nowrap">New Tenant</span>
                </Button>
            </div>
